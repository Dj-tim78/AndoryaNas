...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-zinc-950 overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-[2.5rem] shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-4 bg-zinc-950 border border-zinc-800 rounded-2xl outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all text-sm"
          ...
          {error && (
            <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-xl text-xs text-rose-400 font-medium animate-in slide-in-from-top-2">
              {error}
            </div>
          )}
